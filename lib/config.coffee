...
#▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤#
		...
		atom.config.onDidChange 'geneus-ui.distractionFree.hideBottom', ->
			hideIdleStatus(atom.config.get('geneus-ui.distractionFree.hideBottom'))
		...
		atom.config.onDidChange 'geneus-ui.distractionFree.hideSpotified', ->
			hideSpotifiedPackage(atom.config.get('geneus-ui.distractionFree.hideSpotified'))
		...
		atom.config.onDidChange 'geneus-ui.treeView.toggleHovers', ->
			toggleItemHoverEffect(atom.config.get('geneus-ui.treeView.toggleHovers'))
